"""
Main training script of NoR-MAE. 
The implementation of training engine and script is largely adopted from the original MAE codebase
...
def get_args_parser():
    ...
    # asymmetry
    parser.add_argument('--asym_mae', action='store_true', default=False)
    parser.add_argument('--random_mae', action='store_true', default=False)
    parser.add_argument('--aln_asym_mae', action='store_true', default=False)
    parser.add_argument('--lamda', default=1e-4, type=float, help='Regularizaiton Penalty of neighborhood')
    parser.add_argument('--token_reg', action='store_true', default=False)
    parser.add_argument('--off_diag', action='store_true', default=False)

    # wandb logger
    parser.add_argument('--project_name', default="nor-mae", help="Weight and Bias Project Name")
    parser.add_argument('--exp_name', default="nor-mae-pretrain", help="Weight and Bias Project Name")
    return parser
...
def main(args):
    ...
    if args.asym_mae:
        print("NoR-MAE is activated!!")
        model = models_nor_mae.__dict__[args.model](
            norm_pix_loss=args.norm_pix_loss, 
            decoder_depth=args.decoder_depth,
            mask_ratio=args.mask_ratio,
            lamda=args.lamda,
            token_reg=args.token_reg,
