"""
Main fine-tuning script of NoR-MAE. 
The implementation of fine-tuning engine and script is largely adopted from the original MAE codebase
...
def get_args_parser():
    ...
    parser.add_argument('--subset', action='store_true', help='Use a subset dataset for semi-supervised learning')
...
def main(args):
    ...
    if True:  # args.distributed:
        ...
        if args.subset:
            print(f"Subset Finetuning!")
            sampler_train = torch.utils.data.RandomSampler(dataset_train, num_samples=13000)
        else:
